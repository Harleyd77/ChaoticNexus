...
from flask import Blueprint, abort, redirect, render_template, session, send_from_directory, url_for
...
def favicon():
    try:
        ...
        if fav_rel:
            ...
            if (
                os.path.commonpath([uploads_dir, os.path.abspath(candidate)]) == os.path.abspath(uploads_dir)
