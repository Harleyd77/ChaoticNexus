...
def get_customer_contact_info():
    ...
    return {
        ...
        "company": customer["company_name"] or f"{customer['first_name']} {customer['last_name']}".strip(),
    }
...
def authenticate_customer_credentials(email: str, password: str) -> Tuple[Optional[dict], Optional[str]]:
